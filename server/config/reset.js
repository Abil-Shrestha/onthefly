...
const createTripsTable = async() => {
    ...
    try {
        ...
        console.error('⚠️ error creating trips table', e)
      }
}
...
const createDestionationsTable = async() => {
    const createDestinationsQuery = `
    ...
    `
    try {
        const res = await pool.query(createDestinationsQuery)
...
const createActivitiesTable = async() => {
    ...
    `
    try {
        const res = await pool.query(createActivitiesQuery)
        console.log('🎉 destinations table created successfully')
      } catch (e) {
        console.error('⚠️ error creating trips table', e)
      }
